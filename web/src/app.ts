...
type CatalogEntry = { kind: "node" | "identity"; domain: string; title: string; description: string; tags: string[]; href: string };

function catalogEntries(s: Status): CatalogEntry[] {
...
function renderCatalog(s: Status) {
